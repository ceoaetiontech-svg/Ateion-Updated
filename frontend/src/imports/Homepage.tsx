    ...
    <div className="clay-card bg-[var(--color-grey-card)] flex h-[400px] sm:h-[450px] md:h-[504px] items-start p-[24px] sm:p-[32px] md:p-[40px] relative shrink-0 w-full md:w-[32%] lg:w-[28%] md:max-w-none">
      <div className="flex flex-col gap-[24px] sm:gap-[32px] items-start justify-center relative shrink-0 w-full md:max-w-[300px]">
        <p className="font-['Inter',sans-serif] leading-[1.4] text-[16px] sm:text-[18px] text-[var(--color-text-primary)]">
          Because <strong>marks</strong> measure memory.
          <br />
          <strong className="font-['IBM Plex Sans',sans-serif] italic text-[18px] sm:text-[20px]">
            Capability
          </strong>{" "}
          <strong className="font-['IBM Plex Sans',sans-serif] italic">
            measures the future.
          </strong>
        </p>
        <p className="font-['Inter',sans-serif] leading-[1.6] text-[13px] sm:text-[14px] text-[var(--color-text-primary)] w-full">
          ...
          integrating AI literacy, innovation, and measurable readiness into
          modern schooling.
        </p>
      </div>
    </div>
      ...
      <FadeIn>
        <div className="flex flex-col gap-[16px] sm:gap-[24px] items-start w-full">
          ...
          <div className="content-stretch flex flex-col sm:flex-row items-start sm:items-center justify-between not-italic relative shrink-0 text-[var(--color-text-primary)] w-full py-[24px] sm:py-[48px] gap-[24px] sm:gap-[64px]">
            <p
              className="font-bold leading-tight relative shrink-0 text-[28px] sm:text-[36px] md:text-[48px] flex-1"
              style={{ fontFamily: "'OV Soge', sans-serif" }}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[16px] sm:gap-[24px] w-full">
            {gridItems.map((item, i) => (
              ...
              >
                <p
                  className="text-[22px] sm:text-[26px] md:text-[30px] font-medium text-[var(--color-text-primary)] leading-[1.05] group-hover:text-[var(--color-primary-hover)] transition-colors"
                  style={{
                ...
                <div className="mt-[20px] sm:mt-[24px] flex flex-col gap-[6px]">
                  <span
                    className="text-[12px] sm:text-[13px] font-bold text-[var(--color-text-primary)] opacity-50 uppercase tracking-wider"
                    style={{ fontFamily: "'Manrope', sans-serif" }}
                  >
                    Source
                  </span>
                  <span
                    className="text-[15px] sm:text-[16px] font-semibold text-[var(--color-text-primary)] opacity-80"
                    style={{ fontFamily: "'Manrope', sans-serif" }}
                  >
                    {item.source}
                  </span>
...
const faqData = [
  {
    ...
    answer:
      "Ateion is a pioneering education technology ecosystem dedicated to bridging the gap between traditional rote learning and real-world capability. We focus on AI literacy, innovation, and measurable readiness, providing students with the tools they need to thrive in a rapidly evolving global landscape.",
  },
  {
    question: "How is Ateion different from traditional education systems?",
    answer:
      "Unlike traditional systems that often prioritize memorization and standardized testing, Ateion emphasizes 'Capability-First' education. We integrate advanced AI tools, project-based learning, and global competency frameworks to ensure students are not just learning facts, but developing actionable skills.",
  },
  {
    question: "Who can partner with Ateion?",
    answer:
      "We partner with forward-thinking K-12 schools, universities, educational institutions, and corporate organizations globally. If you are committed to future-proofing education and empowering the next generation with AI-driven capabilities, we invite you to connect with us.",
  },
  {
    question: "What is the Global Capability Olympiad (GCO)?",
    answer:
      "The GCO is our flagship global competition that evaluates students based on their real-world problem-solving abilities and AI proficiency rather than academic recall. It serves as a benchmark for world-class capability and innovation among students worldwide.",
  },
  {
    question: "How are capabilities measured?",
    answer:
      "Capabilities are measured through our proprietary assessment framework that tracks innovation, problem-solving, digital literacy, and collaborative skills. We use real-time data and AI-driven insights to provide a comprehensive profile of a student's readiness for the future.",
  },
  {
    question: "How can institutions get connected?",
    answer:
      "Institutions can get connected by visiting our 'Get Connected' section or reaching out via email at destiny@ateion.com. Our team will guide you through the partnership process, from initial workshops to full ecosystem integration.",
  },
];
...
function FAQItem({
  ...
  return (
    <div className="clay-faq mb-[12px] relative overflow-hidden">
      ...
      >
        <span
          className="flex-[1_0_0] font-semibold leading-[1.35] max-w-[700px] not-italic relative text-[var(--color-text-primary)] text-[18px] sm:text-[20px] md:text-[22px] transition-colors group-hover:text-[var(--color-primary)]"
          style={{ fontFamily: "'SF Pro Display', sans-serif" }}
        >
          {question}
        </span>
        <div
          className={`bg-[var(--color-background-tertiary)] content-stretch flex items-center p-[6px] sm:p-[8px] relative rounded-[100px] shrink-0 transition-transform duration-500 ${isOpen ? "rotate-90" : ""}`}
          aria-hidden="true"
        >
          <ChevronRight
            size={20}
        ...
        {isOpen && (
          ...
          >
            <div className="px-[20px] sm:px-[32px] pb-[20px] sm:pb-[32px] pt-[8px]">
              <p
                className="leading-relaxed text-[15px] sm:text-[16px] text-[var(--color-text-muted)] max-w-[750px]"
                style={{ fontFamily: "'SF Pro Display', sans-serif" }}
              >
                {answer}
              </p>
  ...
  return (
    <div className="flex flex-col items-center w-full px-[16px] sm:px-[24px] md:px-[64px] py-[40px] sm:py-[60px] mb-[40px] sm:mb-[60px]">
      <div className="content-stretch flex flex-col gap-[32px] items-center relative shrink-0 w-full max-w-[1044px]">
        {/* Title */}
        <p
          className="leading-[1.19] not-italic text-[24px] sm:text-[28px] md:text-[32px] text-[var(--color-text-primary)] text-center"
          style={{ fontFamily: "'SF Pro Display', sans-serif" }}
        >
...
export default function Homepage() {
  return (
    <div
      className="bg-[var(--color-background-primary)] w-full min-h-screen overflow-x-hidden flex flex-col gap-[80px] sm:gap-[100px] md:gap-[120px]"
      data-name="Homepage"
    >
