                ...
                {isMobile && onReadMore ? (
                    <>
                        <button
                            ...
                            className="w-full bg-[var(--color-accent)] text-white py-3 rounded-xl text-sm font-bold hover:brightness-110 transition-all text-center shadow-md cursor-pointer"
                        >
                            Read More
                        </button>
                        {onPreview && (
