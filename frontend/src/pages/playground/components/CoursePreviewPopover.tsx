      ...
      <AnimatePresence>
        {isOpen && !isMobile && (
          <motion.div
            ...
            className={`absolute top-1/2 -translate-y-1/2 w-[360px] bg-[var(--color-background-secondary)] rounded-2xl shadow-[0_24px_80px_rgba(0,0,0,0.22)] border border-[var(--color-border-medium)] ${position === "right" ? "left-full ml-4" : "right-full mr-4"
              } z-50 cursor-default`}
          >
            <div
              className={`absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-[var(--color-background-secondary)] transform rotate-45 ${position === "right"
                ...
                <div className="flex flex-col gap-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className={`w-12 h-12 rounded-xl border flex items-center justify-center transition-colors shrink-0 cursor-pointer ${isSaved
